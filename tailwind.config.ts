...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ["SF Pro Display", "Geist", "Inter", "system-ui", "sans-serif"],
      ...
      boxShadow: {
        ...
        "glow-blue": "0 0 20px rgba(56,139,253,0.3), 0 0 40px rgba(56,139,253,0.1)",
        "glow-purple": "0 0 20px rgba(138,75,255,0.3), 0 0 40px rgba(138,75,255,0.1)",
      },
      backgroundImage: {
