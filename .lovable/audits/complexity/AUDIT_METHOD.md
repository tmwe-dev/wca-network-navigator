...
- ciclomatica *stimata*: conteggio `if/else/for/while/case/catch/&&/||/?:/return`
...
- fan-in / fan-out calcolati sull'import graph statico *dei soli file semantici*.
...
- Import graph solo statico → orfani sono *candidati*, non conferme.
