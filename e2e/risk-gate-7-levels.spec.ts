/**
 * Smoke E2E — Risk Gate 7 Levels
 *
 * Enum ai_action_risk a 7 livelli, hard gate visibile su ai_pending_actions.
 */
import { test, expect } from "./fixtures/auth";

test.describe("risk-gate-7-levels", () => {
  test("page loads without crash", async ({ authedPage: page }) => {
    await page.goto("/v2/ai-control");
