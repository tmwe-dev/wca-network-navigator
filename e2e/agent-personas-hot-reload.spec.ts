/**
 * Smoke E2E — Agent Personas Hot Reload
 *
 * Tab Personas DB-driven: modifica si propaga senza redeploy (agent_personas table).
 */
import { test, expect } from "./fixtures/auth";

test.describe("agent-personas-hot-reload", () => {
