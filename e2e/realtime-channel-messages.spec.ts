/**
 * Smoke E2E — Realtime Channel Messages
 *
 * Inreach subscribe realtime su channel_messages con dedup messaggi.
 */
import { test, expect } from "./fixtures/auth";

test.describe("realtime-channel-messages", () => {
  test("page loads without crash", async ({ authedPage: page }) => {
    await page.goto("/v2/inreach");
