/**
 * Smoke E2E — Autoresponder Template Only
 *
 * Email Intelligence mostra template autoresponder pre-approvati (unica eccezione journalistReview).
 */
import { test, expect } from "./fixtures/auth";

test.describe("autoresponder-template-only", () => {
