/**
 * Smoke E2E — Prompt Version Rollback
 *
 * Catalog dei prompt operativi con versioni. Rollback via rollback_prompt_to_version() (server-side).
 */
import { test, expect } from "./fixtures/auth";

test.describe("prompt-version-rollback", () => {
  test("page loads without crash", async ({ authedPage: page }) => {
    await page.goto("/v2/prompt-lab/catalog");
