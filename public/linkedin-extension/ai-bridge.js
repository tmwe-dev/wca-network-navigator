...
var AiBridge =
  ...
  (function () {
      ...
      try {
        ...
        for (const t of tabs) {
          ...
          try {
            ...
            /* tab may be closed / no permission */
          }
        }
        ...
        console.debug("[LI Bridge] findTab:", err?.message);
      }
      return null;
    }
    ...
    function aiExtractRequest(payload) {
      return sendRequest("from-extension-ai-request", "from-webapp-ai-response", payload);
    }

    function liCookieRequest(payload) {
      return sendRequest("from-extension-li-cookie-request", "from-webapp-li-cookie-response", payload);
    }

    function liCredsRequest() {
      return sendRequest("from-extension-li-creds-request", "from-webapp-li-creds-response", {});
    }
