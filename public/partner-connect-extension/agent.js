...
const Agent = {
  ...
  clickScript() {
    return async function (selector, options) {
      ...
      el.dispatchEvent(
        new MouseEvent("mouseover", { bubbles: true, cancelable: true, composed: true, view: window, button: 0 }),
      );
      el.dispatchEvent(
        new MouseEvent("mouseenter", { bubbles: true, cancelable: true, composed: true, view: window, button: 0 }),
      );
      await new Promise((r) => setTimeout(r, 100 + Math.random() * 200));

      el.dispatchEvent(
        new MouseEvent("mousedown", { bubbles: true, cancelable: true, composed: true, view: window, button: 0 }),
      );
      await new Promise((r) => setTimeout(r, 50 + Math.random() * 80));
      el.dispatchEvent(
        new MouseEvent("mouseup", { bubbles: true, cancelable: true, composed: true, view: window, button: 0 }),
      );
      el.dispatchEvent(
        new MouseEvent("click", { bubbles: true, cancelable: true, composed: true, view: window, button: 0 }),
      );
  ...
  snapshotScript() {
    return function () {
      ...
      const snapshot = {
        ...
        mainText: (document.querySelector('main, article, [role="main"]') || document.body).textContent
          ?.trim()
          .slice(0, 2000),
      };
