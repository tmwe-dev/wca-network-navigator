---
title: Risposta a richiesta preventivo
tags: [operative, procedures, email, quote, quote-request]
---
...
3. **Proposta tariffaria**: Presenta tariffe con chiarezza, includi:
   - Costo unitario
   - Costo totale
   - Eventuali sconti volume (se applicabile)
   - Tempi di validità dell'offerta (es. "valida 30 giorni")
4. **Condizioni di fornitura**: Tempi di consegna, modalità di pagamento, documentazione
5. **Differenziale competitivo**: Perché scegliere noi (velocità, reliability, expertise)
...
```
Grazie [Nome] per la fiducia. Ho i vostri dettagli:
- Servizio: [SERVICE]
- Volumi: [VOLUME]
- Tempi: [TIMELINE]

Sulla base di questi parametri, la nostra proposta è:
- Tariffa unitaria: €[X]
- Totale: €[Y] (disponibile sconto del 5% oltre 1000 unità)
- Tempi di consegna: [DAYS] giorni
- Validità offerta: 30 giorni

Cosa vi differenzia scegliendo noi:
[2-3 punti di valore unici]

Volete confermarlo o approfondire qualche aspetto?
```
