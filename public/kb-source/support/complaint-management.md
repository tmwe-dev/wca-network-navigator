...
tags: [support, procedures, email, complaints, customer-service, escalation]
---
...
1. **Empatia**: il cliente si sente ascoltato, non giustificato
2. **Rapidità**: prima risposta entro 24 ore
3. **Trasparenza**: spiega esattamente cosa accadrà
4. **Ownership**: prendi responsabilità anche se non è tua colpa
5. **Follow-up**: non abbandoni il cliente finché non è risolto
...
3. **Classifica la gravità**:
   - **CRITICO**: consegna mai arrivata, perdita economica > 50%
   - **ALTO**: ritardo > 24h, danno qualità, servizio interrotto
   - **MEDIO**: lieve ritardo, comunicazione assente, piccolo danno
   - **BASSO**: inconveniente minore, risolvibile in 1-2 step

### Step 2: Comunicazione iniziale

Template risposta OBBLIGATORIA (entro 4 ore):

```
Caro [Nome],

Ho ricevuto il tuo reclamo in merito a [DESCRIZIONE BREVE].

Capisco il tuo disappunto. Sto analizzando la situazione con i team coinvolti e ti farò sapere le prossime azioni entro [TIMELINE - es. 24 ore].

Riferimento reclamo: [COMPLAINT_ID]
Responsabile: [YOUR_NAME] - [PHONE]

Nel frattempo, se hai domande, contattami direttamente.
...
- Se billing: verifica con amministrazione
...
## Template riposta risolutiva

```
Caro [Nome],

Ho completato l'indagine sul vostro reclamo.

COSA È SUCCESSO:
[SPIEGAZIONE NEUTRA - non scusarsi troppo, né giustificarsi]

COSA FAREMO:
[SOLUZIONE CONCRETA]
- Opzione 1: [RIMBORSO/SERVIZIO]
- Opzione 2: [ALTERNATIVA]

NEXT STEPS:
Vi contatto domani alle [HORA] per confermarlo. Potete rispondermi anche adesso se preferite accelerare.

Ancora scuse per l'inconveniente. Voglio assicurarvi che non accada più.
...
- Comunicazioni (salva tutte le email)
...
- ✓ "Ecco cosa farò..."
- ✓ "Grazie di averci dato l'opportunità di migliorare"
