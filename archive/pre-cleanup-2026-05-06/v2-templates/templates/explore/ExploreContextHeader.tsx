...
const TABS: readonly TabDef[] = [
  {
    key: "command",
    label: "Plancia di Comando",
    to: "/v2/command",
    icon: LayoutDashboard,
    matchPaths: ["/v2/command"],
  },
  {
    key: "network",
    label: "WCA Partner",
    ...
    counterKey: "network",
    unitLabel: "partner",
    matchPaths: ["/v2/explore/network"],
  },
  {
    key: "contacts",
    label: "Contatti CRM",
    to: "/v2/explore/contacts",
    icon: Users,
    counterKey: "contacts",
    unitLabel: "contatti",
    matchPaths: ["/v2/explore/contacts"],
  },
  {
    key: "biglietti",
    label: "Biglietti",
    to: "/v2/explore/biglietti",
    icon: IdCard,
    counterKey: "biglietti",
    unitLabel: "biglietti",
    matchPaths: ["/v2/explore/biglietti"],
  },
  {
    key: "map",
    label: "Mappa",
    ...
    counterKey: "map",
    unitLabel: "paesi",
    matchPaths: ["/v2/explore/map"],
  },
  {
    key: "campaigns",
    label: "Campagne",
    to: "/v2/explore/campaigns",
    icon: Megaphone,
    matchPaths: ["/v2/explore/campaigns"],
  },
  {
    key: "deep",
    label: "Sherlock",
    to: "/v2/explore/deep-search",
    icon: SearchCheck,
    matchPaths: ["/v2/explore/deep-search"],
  },
] as const;
...
export function ExploreContextHeader(): React.ReactElement | null {
  ...
  return (
    <div className="flex items-center gap-1 min-w-0" data-testid="explore-context-header">
      <button
        type="button"
        onClick={() => goTo(-1)}
      ...
      <div id="explore-header-actions" className="flex items-center gap-2 shrink-0 ml-2" />
    </div>
  );
}
