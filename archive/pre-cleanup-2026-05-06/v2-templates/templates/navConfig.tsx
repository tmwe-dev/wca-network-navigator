...
export const navItemsDef: readonly NavItemDef[] = [
  ...
  {
    labelKey: "nav.finder_api_catalog",
    path: "/v2/finder-api/schema",
  ...
  {
    labelKey: "nav.prompt_reader",
    path: "/v2/prompt-reader",
