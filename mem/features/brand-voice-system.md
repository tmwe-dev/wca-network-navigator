...
2. **agent_personas / journalist cards** — 4 ruoli editoriali (rompighiaccio, risvegliatore, chiusore, accompagnatore) con tono/donts/must*know in `app_settings` (chiavi `journalist*<role>\_\*`).
...
- `supabase/functions/_shared/journalistTypes.ts` (campi opzionali brand*voice*\*)
