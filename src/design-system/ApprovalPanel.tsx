    ...
    {visible && (
      <motion.div
        ...
        style={{
          ...
          boxShadow: "0 0 40px hsl(var(--success) / 0.03)",
        }}
      >
        ...
        {governance && (
          <motion.div
            ...
            style={{ background: "hsl(var(--success) / 0.05)", border: "1px solid hsl(var(--success) / 0.08)" }}
          >
            ...
            <span className="text-[6px] text-muted-foreground">·</span>
            <span className="text-[8px] text-muted-foreground font-mono">{governance.policy}</span>
          </motion.div>
        )}
        ...
        <div className="flex items-center gap-2 ml-6">
          ...
          {onModify && (
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={onModify}
              className="text-[11px] px-4 py-2 rounded-xl text-muted-foreground hover:text-foreground hover:bg-secondary/10 transition-all duration-500 flex items-center gap-1.5"
            >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            onClick={onCancel}
            className="text-[11px] px-3 py-2 rounded-xl text-muted-foreground hover:text-foreground transition-all duration-500"
          >
            <X className="w-3 h-3" />
          </motion.button>
        </div>
