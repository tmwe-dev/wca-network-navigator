...
export function SidebarBanner({ icon: Icon, title, description, tone = "primary", className }: SidebarBannerProps) {
  return (
    <section
      className={cn("rounded-lg border px-3 py-2.5 mb-1", TONE_CLASSES[tone], className)}
