...
import { FilterSection, ChipGroup, Chip, EMAIL_CATEGORIES, EMAIL_SORT } from "./shared";
...
export function InboxFilters({ channel, channelIcon: ChannelIcon }: InboxFiltersProps) {
