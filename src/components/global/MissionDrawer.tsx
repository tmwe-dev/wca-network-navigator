    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className={cn("p-0 flex flex-col border-l border-primary/10 bg-background/95 backdrop-blur-xl", !drawerWidth && "w-[90vw] sm:w-[520px] md:w-[600px] lg:w-[680px] sm:max-w-[700px]")} style={drawerWidth ? { width: drawerWidth, maxWidth: "80vw" } : undefined}>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4 min-h-0">
          ...
          {/* Network actions */}
          {isNetwork && (
            <ContextSection title="Azioni Network" icon={Globe} color="text-muted-foreground">
          ...
          {/* Settings actions */}
          {isSettings && (
            <ContextSection title="Strumenti" icon={Settings} color="text-primary">
        ...
        <Dialog open={docsDialogOpen} onOpenChange={setDocsDialogOpen}>
          <DialogContent className="max-w-md">
            <DialogHeader>
              <DialogTitle className="text-sm flex items-center gap-2"><Paperclip className="w-4 h-4 text-primary" /> Documenti ({m.documents.length})</DialogTitle>
