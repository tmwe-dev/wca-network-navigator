...
import { Brain, Bot, Settings, Workflow, Library, Volume2, Power, SlidersHorizontal } from "lucide-react";
...
export function ManualChapters() {
  return (
    <>
      <SectionWrapper className="bg-[#0a0a0f]">
        <div className="space-y-6 max-w-4xl">
          ...
          <p className="text-lg text-white/50 leading-relaxed">
            Le pagine che seguono sono <span className="text-white/80">foto reali del programma</span>: spiegano dove
            configurare le parti vitali, come istruire gli agenti e i servizi AI con i prompt, come aggiornare la
            Knowledge Base e come leggere e organizzare le attività automatizzate. Per ogni schermata trovi{" "}
            <span className="text-white/70">dove si trova</span>,<span className="text-white/70"> cosa puoi fare</span>{" "}
            e <span className="text-white/70">come si aggiorna</span>.
          </p>
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="rounded-xl border border-primary/20 bg-primary/5 p-5 space-y-2">
              <div className="flex items-center gap-2 text-primary">
                <Settings className="w-5 h-5" />
                <h3 className="font-bold text-white">Tutto parte da Config</h3>
              </div>
              <p className="text-sm text-white/50">
                La configurazione vitale (connessioni, agenti, voce, prompt, KB, processi automatici) vive nei gruppi
                del menu sinistro di <span className="font-mono text-white/70">/v2/settings</span>.
              </p>
            </div>
            <div className="rounded-xl border border-white/10 bg-white/5 p-5 space-y-2">
              <div className="flex items-center gap-2 text-primary">
                <Brain className="w-5 h-5" />
                <h3 className="font-bold text-white">Il Cervello del sistema</h3>
              </div>
              <p className="text-sm text-white/50">
                Agenti, capacità/tool, prompt, provider AI e memoria sono ciò che determina{" "}
                <span className="text-white/70">come</span> il sistema pensa e scrive.
              </p>
            </div>
          </div>
        </div>
      ...
      <ManualChapter
        number="01"
        area="Config · impostazioni di sistema"
        icon={Settings}
        title="Dove si configura il sistema"
        subtitle="La mappa dei gruppi di impostazioni"
        path="/v2/settings"
        screenshot={shotConfig}
        screenshotAlt="Pagina Config con i gruppi di impostazioni nel menu sinistro"
      ...
      <ManualChapter
        number="02"
        area="Cervello · agenti"
        icon={Bot}
        title="Come istruire gli agenti"
        subtitle="Il roster dei consulenti AI e la loro persona"
        path="/v2/intelligence/agents"
        screenshot={shotAgentsHub}
        screenshotAlt="Hub conversazionale con il roster degli agenti AI"
      ...
      <ManualChapter
        number="03"
        area="Cervello · capacità"
        icon={SlidersHorizontal}
        title="Capacità e tool degli agenti"
        subtitle="Cosa ciascun agente è autorizzato a fare"
        path="/v2/agents/capabilities"
        screenshot={shotCapabilities}
        screenshotAlt="Pagina capacità agenti con tool assegnati e gap operativi"
      ...
      <ManualChapter
        ...
        area="Config · AGENTI"
        icon={Brain}
        title="Servizi AI: prompt e provider"
        subtitle="I prompt operativi e il modello che li esegue"
        path="/v2/settings?tab=ai-prompt"
        screenshot={shotAiPrompt}
        screenshotAlt="Tab AI & Prompt con i prompt raggruppati per fase"
      ...
      <ManualChapter
        ...
        icon={Volume2}
        title="Voce AI"
        subtitle="Lingua, voce e agente vocale"
        path="/v2/settings?tab=voce-ai"
        screenshot={shotVoce}
        screenshotAlt="Tab Voce AI con lingua, voce predefinita e Voice ID"
        ...
        blocks={[
          {
            kind: "where",
            title: "Dove si trova",
            items: ["Config → AGENTI → Voce AI", "Tab interni: 'Voce & Agente' e 'Avanzate'"],
          },
          {
            kind: "do",
            title: "Cosa puoi fare",
      ...
      <ManualChapter
        ...
        area="Config · AGENTI"
        icon={Library}
        title="Knowledge Base: cosa sa il sistema"
        subtitle="Le schede di conoscenza e come aggiornarle"
        path="/v2/settings?tab=ai-prompt"
        screenshot={shotKb}
        screenshotAlt="Tab Knowledge Base con schede per categoria"
      ...
      <ManualChapter
        number="07"
        area="Config · CONTATORI"
        icon={Power}
        title="Le attività automatizzate"
        subtitle="Accendere, spegnere e regolare i worker"
        path="/v2/settings?tab=processi-automatici"
        screenshot={shotProcessi}
        screenshotAlt="Processi AI automatici con interruttori, frequenza e costo stimato"
      ...
      <ManualChapter
        number="08"
        area="Comando · autopilot"
        icon={Workflow}
        title="Autopilot e attività degli agenti"
        subtitle="Missioni autonome e task generati"
        path="/v2/agents/autopilot"
        screenshot={shotAutopilot}
        screenshotAlt="Pagina Agent Missions con creazione nuova missione"
