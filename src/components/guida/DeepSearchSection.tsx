...
const steps = [
  {
    icon: Search,
    title: "Scoperta Sito Web",
    desc: "Estrazione dominio dall'email aziendale o ricerca via Partner Connect",
  },
  { icon: FileText, title: "Scraping Contenuti", desc: "About, servizi, contatti — estratti automaticamente dal sito" },
  {
    icon: Brain,
    title: "Analisi AI",
    desc: "Descrizione, punti chiave, servizi elaborati dall'intelligenza artificiale",
  },
  ...
  { icon: MessageCircle, title: "Link WhatsApp", desc: "Generazione automatica wa.me dal numero di telefono" },
  {
    ...
    desc: "LinkedIn, Facebook, Instagram, Twitter — trovati automaticamente",
  },
];
      ...
      <div className="space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-white/40 text-lg max-w-2xl mx-auto">
            Da un semplice nome azienda a un profilo completo con sito, logo, social, servizi e descrizione AI. Singolo
            o bulk su centinaia di partner.
          </p>
        </div>
        <div className="relative">
          ...
          <div className="space-y-6">
            {steps.map(({ icon: Icon, title, desc }, i) => (
              ...
              >
                <div
                  className={`flex-1 p-6 rounded-xl bg-white/[0.02] border border-white/5 ${i % 2 === 0 ? "md:text-right" : ""}`}
                >
