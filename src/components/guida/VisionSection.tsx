        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="p-8 rounded-2xl bg-red-500/5 border border-red-500/10 space-y-4">
            ...
            <ul className="space-y-3 text-white/50">
              {[
                "Ricerca manuale su directory WCA",
                "Copia-incolla dati in Excel",
                "Email generiche a tutti",
                "Nessun follow-up sistematico",
                "Lavoro solo in orario ufficio",
          ...
          <div className="p-8 rounded-2xl bg-emerald-500/5 border border-emerald-500/10 space-y-4">
            ...
            <ul className="space-y-3 text-white/50">
              {[
                "Scraping automatico directory",
                "Database centralizzato con enrichment AI",
                "Email AI personalizzate per partner",
                "Follow-up automatici multi-canale",
                "Agenti autonomi 24/7",
                "Deep profiling con AI",
              ].map((t) => (
                <li key={t} className="flex items-start gap-3">
          ...
          {[
            {
              icon: Brain,
              title: "AI Agents",
              desc: "Team di agenti autonomi che lavorano in parallelo, ognuno con competenze specifiche",
            },
            {
              icon: Target,
              title: "Deep Search",
              desc: "Arricchimento automatico: siti web, social, servizi, logo — tutto scoperto dall'AI",
            },
            {
              icon: Zap,
              title: "Multi-Channel",
              desc: "Email, WhatsApp, LinkedIn — comunicazione unificata su tutti i canali",
            },
            {
              icon: TrendingUp,
              title: "Smart Outreach",
              desc: "Email generate dall'AI, personalizzate per ogni partner, con variabili dinamiche",
            },
            {
              icon: Shield,
              title: "Human Behavior",
              desc: "Delay randomizzati, pausa notturna, rate limiting — comportamento indistinguibile dall'umano",
            },
            {
              icon: Clock,
              title: "24/7 Autonomy",
              desc: "Ciclo autonomo ogni 10 minuti: screening, assegnazione, esecuzione, follow-up",
            },
          ].map(({ icon: Icon, title, desc }) => (
            <div
              key={title}
              className="p-6 rounded-xl bg-white/[0.02] border border-white/5 hover:border-primary/20 transition-all group space-y-3"
            >
      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-3">
          {[
            ...
            {
              layer: "AI Engine",
              tech: "GPT-5 + Gemini 2.5 Pro via Gateway",
