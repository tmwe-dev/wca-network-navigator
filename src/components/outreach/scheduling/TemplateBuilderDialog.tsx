          ...
          <div className="space-y-4 pb-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="col-span-3">
                ...
                <Input
                  ...
                  placeholder="Es. Follow-Up Fiera Milano"
              ...
              <div className="flex items-end">
                <Badge variant="outline" className="text-[10px] h-5">
                  {steps.length} step · {totalDays} giorni
                </Badge>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              {steps.map((step, idx) => (
                <div
                  key={idx}
                  className="grid grid-cols-[auto_1fr_80px_1fr_1fr_1fr_auto] gap-1.5 items-center p-2 rounded-lg bg-card/40 border border-border/20"
                >
                  ...
                  <Input
                    value={step.template_hint}
                    onChange={(e) => updateStep(idx, { template_hint: e.target.value })}
                    placeholder="Hint..."
