...
export function WhatsAppChatThread({
    ...
    return (
      contact
        .replace(
          ...
          /[\u{1F600}-\u{1F6FF}\u{1F900}-\u{1F9FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}\u{FE00}-\u{FE0F}\u{200D}\u{20E3}\u{E0020}-\u{E007F}]/gu,
          "",
        )
        .trim() || contact.trim()
    );
  ...
  return (
    ...
    >
      ...
      {/* Chat header */}
      <div
        className="flex-shrink-0 px-4 py-2.5 border-b border-border flex items-center justify-between"
          ...
          {chatMode && (
            <Button
              ...
              className={cn(
                ...
                chatMode.active && "bg-emerald-600 hover:bg-emerald-700 text-white",
              )}
          ...
          {(() => {
            ...
            msgs.forEach((msg) => {
              ...
              elements.push(
                <div
                  key={msg.id}
                  className={cn("flex", isOut ? "justify-end" : "justify-start", isFirstInCluster ? "mt-3" : "mt-0.5")}
                >
                  <div
                    className={cn(
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  size="icon"
                  variant="ghost"
                  className="h-9 w-9 text-muted-foreground cursor-not-allowed"
                  disabled
