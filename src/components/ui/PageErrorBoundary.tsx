      ...
      return (
        <div className="flex flex-col items-center justify-center h-full gap-4 p-8 text-center">
          ...
          <button
            ...
            className="px-4 py-2 text-sm rounded-md bg-card/60 dark:bg-card/40 border border-primary/60 text-primary hover:bg-primary/15 hover:border-primary transition-colors"
          >
            Ricarica pagina
          </button>
        </div>
