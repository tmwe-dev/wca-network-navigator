      ...
      <div className="flex items-center gap-1.5 flex-wrap">
        ...
        {onCockpit && (
          <Tooltip>
            ...
            <TooltipContent className="text-xs">Invia al Cockpit</TooltipContent>
          </Tooltip>
        )}
        ...
        {onEmail && withEmail > 0 && (
          <Tooltip>
            ...
            <TooltipContent className="text-xs">Invia email</TooltipContent>
          </Tooltip>
        )}
        ...
        {onWhatsApp && withPhone > 0 && (
          <Tooltip>
            ...
            <TooltipContent className="text-xs">Invia WhatsApp</TooltipContent>
          </Tooltip>
        )}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                variant="ghost"
                className={btn}
                onClick={onLinkedInDM}
                disabled={linkedInDMLoading || withLinkedIn === 0}
              >
                {linkedInDMLoading ? (
            ...
            <TooltipContent className="text-xs">
              Invia DM LinkedIn (rate limit: 3/ora — distribuiti su ~{Math.max(1, Math.ceil((withLinkedIn * 21) / 60))}
              h)
            </TooltipContent>
          </Tooltip>
        )}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button size="sm" variant="ghost" className={btn} onClick={onDeepSearch} disabled={deepSearchLoading}>
                {deepSearchLoading ? <Loader2 className="w-3 h-3 animate-spin" /> : <Sparkles className="w-3 h-3" />}{" "}
                Deep Search
              </Button>
            </TooltipTrigger>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button size="sm" variant="ghost" className={btn} onClick={onLinkedIn} disabled={linkedInLoading}>
                {linkedInLoading ? <Loader2 className="w-3 h-3 animate-spin" /> : <Linkedin className="w-3 h-3" />}{" "}
                LinkedIn
              </Button>
            </TooltipTrigger>
            <TooltipContent className="text-xs">Cerca profili LinkedIn</TooltipContent>
          </Tooltip>
        )}
        ...
        {onGoogleLogo && (
          <Tooltip>
            ...
            <TooltipContent className="text-xs">Cerca logo su Google</TooltipContent>
          </Tooltip>
        )}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button size="sm" variant="ghost" className={btn} onClick={onDeduplicate} disabled={deduplicateLoading}>
                {deduplicateLoading ? <Loader2 className="w-3 h-3 animate-spin" /> : <Layers className="w-3 h-3" />}{" "}
                Consolida
              </Button>
            </TooltipTrigger>
            <TooltipContent className="text-xs">Consolida duplicati</TooltipContent>
          </Tooltip>
        )}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button size="sm" variant="ghost" className={btn} onClick={onWcaMatch} disabled={wcaMatchLoading}>
                {wcaMatchLoading ? <Loader2 className="w-3 h-3 animate-spin" /> : <Link2 className="w-3 h-3" />} WCA
                Match
              </Button>
            </TooltipTrigger>
            <TooltipContent className="text-xs">Verifica associazione WCA</TooltipContent>
          </Tooltip>
        )}
        ...
        {onDelete && (
          <Tooltip>
            ...
            <TooltipContent className="text-xs">Elimina selezionati</TooltipContent>
          </Tooltip>
        )}
