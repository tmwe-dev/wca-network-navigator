    ...
    <>
      ...
      <button
        ...
        className={cn(
          ...
          selectedName ? "border-primary/20 bg-primary/5" : "border-border/50 bg-muted/20",
        )}
      >
        ...
        <span
          className={cn(
            ...
            selectedName ? "font-medium text-foreground" : "text-muted-foreground",
          )}
        >
      ...
      <Dialog open={pickOpen} onOpenChange={setPickOpen}>
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-hidden flex flex-col">
          <DialogHeader>
            ...
            <DialogDescription className="text-sm">Scegli dalla libreria o crea un nuovo contenuto</DialogDescription>
          </DialogHeader>
