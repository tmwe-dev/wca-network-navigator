              ...
              return (
                <div key={step} className="flex items-center gap-1">
                  ...
                  {i < chainSteps.length - 1 && (
                    <span className={`text-[7px] ${isActive ? "text-muted-foreground" : "text-muted-foreground"}`}>
                      →
                    </span>
                  )}
                </div>
              ...
              return (
                ...
                >
                  ...
                  <tool.icon
                    ...
                    style={{ color: `hsl(${tool.color} / ${revealed ? 0.35 : 0.1})` }}
                    strokeWidth={1.5}
                  />
                  <span
                    className="text-[8px] font-light"
                    style={{ color: `hsl(${tool.color} / ${revealed ? 0.4 : 0.12})` }}
                  >
                    {tool.label}
                  </span>
                </motion.div>
            ...
            <div className="flex items-center gap-1 py-1 px-1 flex-wrap">
              ...
              {sources.map((src, i) => (
                <motion.span
                  ...
                  style={{
                    color: `hsl(${src.color} / 0.35)`,
                    background: `hsl(${src.color} / 0.03)`,
                    border: `1px solid hsl(${src.color} / 0.04)`,
                  }}
                >
                  {src.name}
                </motion.span>
