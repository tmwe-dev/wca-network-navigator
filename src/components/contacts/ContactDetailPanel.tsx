...
export function ContactDetailPanel({ contact, onContactUpdated }: Props) {
  const {
    state, dispatch, interactions, matchedCard, needsAlias,
  ...
  return (
    <div className="h-full overflow-y-auto p-5 space-y-4">
      ...
      <ContactEnrichmentCard enrichmentData={c.enrichment_data as Record<string, unknown> | undefined} deepSearchAt={c.deep_search_at} />
