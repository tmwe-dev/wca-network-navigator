...
import {
  ...
  ContactTabContent,
  NotesTabContent,
} from "@/components/contacts/add-contact/ContactFormStep";
      ...
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto" data-testid="dialog-add-contact">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">
            Maschera di inserimento manuale con ricerca Google, logo, LinkedIn e Deep Search collegati al record
            salvato.
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue="search" className="w-full">
          ...
          <TabsContent value="search">
            <ContactSearchStep
              ...
              placesLoading={ui.placesLoading}
              placesResults={c.state.placesResults}
              onFieldChange={c.setField}
              onSearch={c.handlePlacesSearch}
              onApplyResult={c.applyPlacesResult}
            />
            <div className="space-y-3 mt-3">
              <ContactEnrichmentPanel
                ...
                savedId={ui.savedId}
                logoLoading={ui.logoLoading}
                linkedinLoading={ui.linkedinLoading}
                deepSearchRunning={c.deepSearchRunning}
                fsBridgeAvailable={c.fsBridgeAvailable}
                onLogoSearch={c.handleLogoSearch}
                onLinkedInSearch={c.handleLinkedInSearch}
