...
/* ═══ Compact List Row ═══ */
export function CompactRow({ card, isSelected, onSelect, onShowDetail, onGoogleLogo: onGoogleLogo: onGoogleLogo: _onGoogleLogo }: {
...
/* ═══ Card Grid Item ═══ */
export function CardGridItem({ card, isSelected, onSelect, onShowDetail, onGoogleLogo: onGoogleLogo: onGoogleLogo: _onGoogleLogo }: {
  card: BusinessCardWithPartner; isSelected: boolean; onSelect: () => void; onShowDetail: () => void; onGoogleLogo: () => void;
}) {
  const sc = STATUS_COLORS[card.match_status] || STATUS_COLORS.pending;
...
/* ═══ Expanded Card ═══ */
export function ExpandedCardItem({ card, isSelected, onSelect, onShowDetail, onGoogleLogo: onGoogleLogo: onGoogleLogo: _onGoogleLogo }: {
  card: BusinessCardWithPartner; isSelected: boolean; onSelect: () => void; onShowDetail: () => void; onGoogleLogo: () => void;
}) {
  const sc = STATUS_COLORS[card.match_status] || STATUS_COLORS.pending;
  const hasPhoto = !!card.photo_url;
