      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            onChange={(e) => onFieldChange("companyAlias", e.target.value)}
            placeholder="Nome abbreviato"
          />
        </div>
      </div>
      <div className="grid grid-cols-2 gap-3">
    ...
    <div className="space-y-3 mt-3">
      <div className="grid grid-cols-2 gap-3">
        ...
        <div className="space-y-1.5">
          <Label className="text-xs">Alias</Label>
          <Input
            value={form.contactAlias}
            onChange={(e) => onFieldChange("contactAlias", e.target.value)}
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            onChange={(e) => onFieldChange("contactMobile", e.target.value)}
            placeholder="+39 333..."
          />
        </div>
      </div>
    ...
    <div className="space-y-3 mt-3">
      <div className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="Es. Fiera Milano 2026, Referral, Cold call..."
        />
      </div>
      <div className="space-y-1.5">
