import { Globe, SlidersHorizontal, Plane, LayoutList, LayoutGrid, Rows3, Calendar } from "lucide-react";
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden">
      ...
      <button
        ...
        className={cn(
          "flex shrink-0 items-center gap-2 border-b border-border/20 px-3 py-2 text-left transition-all",
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-[9px] text-muted-foreground">
            {totalCompanies} aziende · {totalContacts} contatti
          </div>
        </div>
      </button>
      ...
      <div className="shrink-0 space-y-2.5 border-t border-border/30 p-3">
        ...
        <div className="space-y-1">
          ...
          <Select value={sortMode} onValueChange={(v) => onSetSortMode(v as SortMode)}>
            ...
            <SelectContent>
              <SelectItem value="matched_first" className="text-xs">
                Match prima
              </SelectItem>
              ...
              <SelectItem value="contacts_desc" className="text-xs">
                Contatti ↓
              </SelectItem>
            </SelectContent>
          </Select>
