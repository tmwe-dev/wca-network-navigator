...
import { LayoutGrid, List, Building2, FileSearch, Users, CreditCard, UserPlus, Filter } from "lucide-react";
      ...
      <div className="px-3 py-1.5 border-b border-border/30">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-1.5 flex-1 min-w-0">
            <Select value={sourceTab} onValueChange={(v) => onSourceTabChange(v as SourceTab)}>
              <SelectTrigger className="h-7 w-[150px] text-[11px] gap-1.5 px-2">
