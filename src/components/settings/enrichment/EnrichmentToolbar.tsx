...
import {
  Search, Filter, CheckCircle2, Linkedin, Globe, ImageOff, XCircle,
} from "lucide-react";
...
export function EnrichmentToolbar({ search, enrichFilter, stats, onSearchChange, onFilterChange }: Props) {
  return (
