...
const SYSTEM_TEMPLATES = [
  {
    name: "Rispondi formale",
    prompt_text: "Rispondi sempre in modo professionale e formale a questo mittente.",
    category: "general",
  },
  {
    name: "Ignora newsletter",
    prompt_text: "Ignora questo mittente. Non classificare, non rispondere, archivia automaticamente.",
    category: "newsletter",
  },
  {
    name: "Priorità alta",
    prompt_text: "Questo mittente è prioritario. Notifica immediatamente e classifica come urgente.",
    category: "general",
  },
  {
    name: "Follow-up commerciale",
    prompt_text: "Analizza il contenuto per opportunità commerciali. Suggerisci follow-up se necessario.",
    category: "commercial",
  },
  {
    name: "Solo monitoraggio",
    prompt_text: "Monitora le email di questo mittente senza azioni automatiche. Log per analisi.",
    category: "general",
  },
  {
    name: "Rispondi cordiale informale",
    prompt_text: "Rispondi in modo cordiale e informale. Tono amichevole.",
    category: "general",
  },
  {
    name: "Supporto tecnico",
    prompt_text: "Classifica come richiesta supporto. Cerca soluzioni nella KB prima di rispondere.",
    category: "support",
  },
  {
    name: "Blocca spam",
    prompt_text: "Questo mittente è spam. Elimina automaticamente tutte le email future.",
    category: "spam",
  },
];
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className={showCustomEdit ? "block" : "hidden"}>
        ...
        <div className="flex gap-2 mt-2">
          <Button size="sm" onClick={handleSaveCustom} disabled={isLoading || !editText.trim()}>
            Salva
          </Button>
