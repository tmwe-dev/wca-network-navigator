        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="es. Clienti, Fornitori, Banca"
              maxLength={50}
            />
            <p className="text-xs text-muted-foreground">
              Inserisci <strong>chi scrive</strong> (Clienti, Fornitori, Banca, Partners…). Non usare nomi di
              azione/destinazione (Operativo, Tasks, RFQ, Support): per quelli ci sono le cartelle FunneMail.
            </p>
