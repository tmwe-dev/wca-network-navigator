...
export const DEFAULT_EXTENSION_CATALOG: ExtensionCatalog = {
  whatsapp: {
    ...
    latestVersion: "5.10.22",
    items: [
      {
        version: "5.10.22",
        filename: "whatsapp-extension-5.10.22.zip",
        path: "/chrome-extensions/whatsapp/whatsapp-extension-5.10.22.zip",
        current: true,
        note: "Sincronizzazione thread ripristinata: apre il JID esatto acquisito dalla sidebar e usa la chat più recente solo per record legacy senza identificativo.",
      },
      {
        version: "5.10.19",
