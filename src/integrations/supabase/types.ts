  ...
  public: {
    Tables: {
      ...
      funnemail_actions_log: {
        Row: {
          action: string;
          action_type: Database["public"]["Enums"]["funnemail_action_type"] | null;
          created_at: string;
          error: string | null;
          from_address: string | null;
          group_id: string | null;
    ...
    Views: {
      ...
      funnemail_brain_v: {
        Row: {
          ...
          job_stage: Database["public"]["Enums"]["email_processing_stage"] | null;
    ...
    Enums: {
      ...
      activity_type:
        ...
        | "whatsapp_message"
        | "linkedin_message";
      ai_action_risk: "READ" | "PREPARE" | "WRITE" | "SEND" | "EXTERNAL_AUTOMATION" | "BULK" | "DESTRUCTIVE";
      ...
      partner_type: "freight_forwarder" | "customs_broker" | "carrier" | "nvocc" | "3pl" | "courier";
      ...
      service_category:
        ...
        | "warehousing"
        | "nvocc";
      social_platform: "linkedin" | "facebook" | "instagram" | "twitter" | "whatsapp";
