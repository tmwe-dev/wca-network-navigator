...
export const LAB_TABS: readonly LabTabConfig[] = [
  ...
  },
  {
    ...
    group: "tests",
    icon: Activity,
    legacyPath: "/v2/settings/e2e-status",
  ...
  // ─── PROMPTS (stesso gruppo "tests") ─────────────────────
  {
    ...
    group: "tests",
    icon: Wand2,
    legacyPath: "/v2/settings/prompt-lab",
  ...
  },
  {
    ...
    group: "tests",
    icon: BookOpen,
    legacyPath: "/v2/prompt-lab/catalog",
  ...
  },
  {
    ...
    group: "tests",
    icon: MapIcon,
    legacyPath: "/v2/prompt-lab/atlas",
  ...
  },
  {
    ...
    group: "tests",
    icon: Lightbulb,
    legacyPath: "/v2/prompt-lab/suggestions",
  ...
  },
  {
    ...
    group: "tests",
    icon: GitBranch,
    legacyPath: "/v2/prompt-lab/proposals",
  ...
  },
  {
    ...
    group: "tests",
    icon: FileText,
    legacyPath: "/v2/settings/prompt-reader",
  ...
  },
  {
    ...
    group: "tests",
    icon: Mic,
    legacyPath: "/v2/settings/brand-voice",
  ...
  // ─── OBSERVABILITY ───────────────────────────────────────
  {
    ...
    group: "observability",
    icon: Stethoscope,
    legacyPath: "/v2/settings/diagnostics",
  ...
  },
  {
    ...
    group: "observability",
    icon: BarChart3,
    legacyPath: "/v2/settings/telemetry",
  ...
  },
  {
    ...
    group: "observability",
    icon: Eye,
    legacyPath: "/v2/settings/observability",
  ...
  },
  {
    ...
    group: "observability",
    icon: BellRing,
    legacyPath: "/v2/settings/alert-routing",
  ...
  },
  {
    ...
    group: "observability",
    icon: MessageSquare,
    legacyPath: "/v2/ai-interactions-log",
  ...
  },
  {
    ...
    group: "observability",
    icon: Coins,
    legacyPath: "/v2/token-cockpit",
    Component: lazy(() => import("@/v2/ui/pages/TokenCockpitPage").then((m) => ({ default: m.TokenCockpitPage }))),
  },
  {
    id: "funnemail-job-ledger",
    label: "Funnemail · Job Ledger",
    group: "observability",
    icon: ListChecks,
    Component: lazy(() => import("@/components/email-intelligence/JobLedgerTab")),
  },
  {
    id: "funnemail-routing-rules",
    label: "Funnemail · Routing Rules",
    group: "observability",
    icon: RouteIcon,
    Component: lazy(() => import("@/components/email-intelligence/RoutingRulesTab")),
  },
  {
    id: "funnemail-scout-cache",
    label: "Funnemail · Scout Cache",
    group: "observability",
    icon: Database,
    Component: lazy(() => import("@/components/email-intelligence/ScoutCacheTab")),
  },
  {
    id: "funnemail-eval-set",
    label: "Funnemail · Eval Set",
    group: "observability",
    icon: TestTube,
    Component: lazy(() => import("@/components/email-intelligence/EvalSetTab")),
  },
  {
    id: "funnemail-eval-accuracy",
    label: "Funnemail · Eval Accuracy",
    group: "observability",
    icon: Target,
    Component: lazy(() =>
      import("@/v2/ui/pages/funnemail-inbox/FunnemailEvalTab").then((m) => ({ default: m.FunnemailEvalTab })),
    ),
  },
  ...
  // ─── DESIGN ──────────────────────────────────────────────
  {
    ...
    group: "design",
    icon: Palette,
    legacyPath: "/v2/design-system-preview",
    Component: lazy(() =>
      import("@/v2/ui/pages/DesignSystemPreviewPage").then((m) => ({ default: m.DesignSystemPreviewPage })),
    ),
  },
] as const;
