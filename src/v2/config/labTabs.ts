...
export const LAB_TABS: readonly LabTabConfig[] = [
  ...
  { id: "funnemail-job-ledger",   label: "Funnemail · Job Ledger",   group: "observability", icon: ListChecks,
    Component: lazy(() => import("@/components/email-intelligence/JobLedgerTab")) },
  { id: "funnemail-routing-rules", label: "Funnemail · Routing Rules", group: "observability", icon: RouteIcon,
    Component: lazy(() => import("@/components/email-intelligence/RoutingRulesTab")) },
  { id: "funnemail-scout-cache",  label: "Funnemail · Scout Cache",  group: "observability", icon: Database,
    Component: lazy(() => import("@/components/email-intelligence/ScoutCacheTab")) },
  { id: "funnemail-eval-set",     label: "Funnemail · Eval Set",     group: "observability", icon: TestTube,
    Component: lazy(() => import("@/components/email-intelligence/EvalSetTab")) },
  { id: "funnemail-eval-accuracy", label: "Funnemail · Eval Accuracy", group: "observability", icon: Target,
    Component: lazy(() => import("@/v2/ui/pages/funnemail-inbox/FunnemailEvalTab").then((m) => ({ default: m.FunnemailEvalTab }))) },
