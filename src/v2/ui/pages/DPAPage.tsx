...
const DPA_SECTIONS = [
  {
    ...
    content:
      "Il presente Accordo sul Trattamento dei Dati (DPA) disciplina il trattamento dei dati personali da parte di WCA Network Navigator ('Responsabile del Trattamento') per conto del Cliente ('Titolare del Trattamento'). Il trattamento ha durata pari al contratto di servizio.",
  },
  {
    title: "2. Natura e Finalità del Trattamento",
    content:
      "I dati vengono trattati esclusivamente per la fornitura del servizio CRM: gestione partner commerciali, invio comunicazioni commerciali autorizzate, analisi AI dei profili aziendali pubblici, e generazione di report.",
  },
  {
    title: "3. Categorie di Dati",
    content:
      "Dati aziendali: ragione sociale, indirizzo, email aziendali, numeri di telefono aziendali, siti web. Dati di contatto: nome, cognome, ruolo, email professionale, telefono diretto. NON vengono trattati dati sensibili (art. 9 GDPR).",
  },
  {
    title: "4. Misure Tecniche e Organizzative",
    content:
      "Crittografia AES-256 at-rest e TLS 1.3 in-transit. Row Level Security a livello database. Autenticazione con hash non reversibile. Backup giornalieri con retention 30 giorni. Logging strutturato con retention 90 giorni. Accesso basato su ruoli con principio del privilegio minimo.",
  },
  {
    title: "5. Sub-Responsabili",
    content:
      "Il servizio utilizza i seguenti sub-responsabili: Supabase Inc. (database e autenticazione, datacenter EU/US), Stripe Inc. (pagamenti), provider AI (OpenAI, Google) per analisi testuale. Ogni sub-responsabile è vincolato da clausole contrattuali equivalenti.",
  },
  {
    title: "6. Diritti degli Interessati",
    content:
      "Il Responsabile assiste il Titolare nell'esercizio dei diritti degli interessati: accesso, rettifica, cancellazione, portabilità, limitazione e opposizione al trattamento. Le richieste vengono evase entro 30 giorni.",
  },
  {
    title: "7. Data Breach",
    content:
      "In caso di violazione dei dati, il Responsabile notifica il Titolare entro 72 ore dalla scoperta, fornendo: natura della violazione, categorie e numero di interessati, conseguenze probabili, e misure adottate o proposte.",
  },
  {
    title: "8. Cancellazione e Restituzione",
    content:
      "Alla cessazione del servizio, il Responsabile cancella tutti i dati personali entro 30 giorni, salvo obblighi di legge. Su richiesta, i dati vengono restituiti in formato CSV prima della cancellazione.",
  },
];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {SOC2_CHECKLIST.map((item) => (
              <div key={item.label} className="flex items-start gap-2 text-sm">
                <CheckCircle2
                  className={`h-4 w-4 mt-0.5 shrink-0 ${item.done ? "text-success" : "text-muted-foreground"}`}
                />
      ...
      <Card className="border-primary/30 bg-primary/5">
        <CardContent className="py-6 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            Per firmare digitalmente il DPA, accedi alla piattaforma e vai su Settings → Legale.
          </p>
