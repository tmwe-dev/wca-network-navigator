...
export const PROMPT_LAB_TABS: readonly PromptLabTabDef[] = [
  ...
  { id: "routing", label: "Routing", description: "Regole DB persona-aware per classificazione e escalation", activation: "Attive in classify-inbound-message: bias pre-classificazione (hint dominio/categoria/tono) + override post-classificazione (next lead_status, action_type, confidence floor, skip-action). Persona-specifiche battono globali. Hard guards e applyLeadStatusChange restano sempre attivi." },
  ...
  { id: "operative_kb", label: "Operativo", description: "KB procedure operative per dominio", activation: "Attive nel classify-inbound-message quando dominio = operative: procedure preventivi, booking, tracking per agents domain-aware." },
  { id: "administrative_kb", label: "Amministrativo", description: "KB procedure amministrative per dominio", activation: "Attive nel classify-inbound-message quando dominio = administrative: procedure fatture, pagamenti, autorizzazioni." },
  { id: "support_kb", label: "Supporto", description: "KB procedure supporto per dominio", activation: "Attive nel classify-inbound-message quando dominio = support: procedure reclami, assistenza, escalation." },
