...
export const SCENARIOS: Record<string, Scenario> = {
  import: {
    ...
    approval: {
      ...
      description:
        "287 profili unici dopo deduplicazione. 23 collegati a partner WCA. 42 arricchiti con Deep Search. Governance check superato.",
      details: [
  ...
  campaign: {
    ...
    approval: {
      ...
      description:
        "50 email personalizzate da 3 fonti unificate. Governance check completato. Approvazione richiesta per Send Email Batch.",
      details: [
  ...
  batch: {
    ...
    approval: {
      ...
      description:
        "118 email pronte. Ogni wave richiede approvazione. Governance Agent monitora ogni step. Audit trail completo.",
      details: [
  ...
  template: {
    ...
    approval: {
      ...
      description:
        "Il template includerà tutti gli step, tool e parametri del flusso corrente. Sarà riutilizzabile dalla Template Library.",
      details: [
