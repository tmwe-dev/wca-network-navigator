...
const SEARCH_VERB_RE = /\b(cerca|trova|mostra|elenca|lista|visualizza|dammi|quanti|quante|ultimi|recenti)\b/i;

const DOMAIN_NOUN_RE = /\b(partner|contatt|prospect|azienda|società|company|attivit|messagg|email|outreach)\b/i;
 ...
 */
export function shouldForceAiQuery(text: string, looksLikeSimpleQuery: (t: string) => boolean): boolean {
  return (
