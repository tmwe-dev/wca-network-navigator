...
export const ALLOWED_TABLES_LIST: readonly AllowedTable[] = [
  ...
  { name: "partner_contacts", defaultSort: { column: "is_primary", ascending: false } },
  { name: "prospects", defaultSort: { column: "created_at", ascending: false } },
  { name: "prospect_contacts", defaultSort: { column: "created_at", ascending: false } },
