...
export default function ComposerCanvas({
  ...
  const autoGenerateDoneRef = useRef(false);
  ...
  useEffect(() => {
    if (autoGenerateDoneRef.current || initialBody || !promptHint.trim()) return;
    autoGenerateDoneRef.current = true;
    composer.generate.mutate(promptHint);
  }, [composer.generate, initialBody, promptHint]);
