/**
 * Telemetry — operator-facing observability page (orchestrator).
 */
import { useMemo } from "react";
import { useTrackPage } from "@/hooks/useTrackPage";
import { useUrlState } from "@/hooks/useUrlState";
import type { TabKey } from "./types";
import { TABS, RANGES } from "./constants";
import { PageEventsView } from "./PageEventsView";
import { RequestLogsView } from "./RequestLogsView";
import { AIRequestLogsView } from "./AIRequestLogsView";
