/**
 * ImportPage V2 — Import e operazioni batch
 */
...
export function ImportPage({ activeView }: { activeView?: "partners" | "bca" }) {
  ...
  return (
    <ThemeCtx.Provider value={isDark}>
      <div data-testid="page-import" className="h-full min-h-0 relative flex flex-col overflow-hidden bg-background">
