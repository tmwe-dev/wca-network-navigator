...
const SETTINGS_GROUPS: SettingsGroupDef[] = [
  ...
  },
  {
    id: "update",
    title: "Update",
    items: [{ value: "enrichment", label: "Arricchimento", icon: Image }],
  },
  {
  ...
  },
  {
    id: "master",
    title: "Master",
    items: [{ value: "development", label: "Development", icon: Layers }],
  },
  {
    id: "test",
    title: "TEST",
    items: [{ value: "lab", label: "Lab & Verifiche", icon: FlaskConical }],
  },
  {
    id: "team",
    title: "Team",
...
function GroupedSettingsNav({ value, onChange }: { value: string; onChange: (v: string) => void }) {
                    ...
                    <div className="float-panel p-5 space-y-2">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Regola la gradazione del nero (tema chiaro) o del bianco (tema scuro) applicata al testo in
