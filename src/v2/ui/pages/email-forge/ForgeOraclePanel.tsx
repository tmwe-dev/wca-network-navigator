  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto p-3 space-y-4">
        ...
        {/* TIPO EMAIL */}
        <section className="space-y-1.5">
          <Label className="text-xs uppercase tracking-wide text-foreground">Tipo email</Label>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    active
                      ...
                      : "bg-card border-border/60 text-foreground hover:bg-muted hover:border-border",
                  )}
                >
                  {t.name}
                </button>
        ...
        {/* OBIETTIVO */}
        <section className="space-y-1.5">
          <Label className="text-xs uppercase tracking-wide text-foreground">Obiettivo</Label>
          <Textarea
        ...
        <Collapsible open={advancedOpen} onOpenChange={setAdvancedOpen}>
          <CollapsibleTrigger className="flex items-center gap-1.5 text-xs text-foreground hover:text-foreground w-full">
          ...
          <CollapsibleContent className="space-y-3 mt-3 pt-3 border-t border-border/60">
            ...
            <div className="space-y-1.5">
              <Label className="text-xs text-foreground">Quality (modello AI)</Label>
              <Select
                value={lab.quality}
            ...
            <div className="space-y-1.5">
              <Label className="text-xs text-foreground">Proposta base (opzionale)</Label>
              <Textarea
