      ...
      <div className="flex-1 overflow-auto p-3 space-y-3">
        ...
        <div>
          ...
          <Tabs defaultValue="preview" className="w-full">
            ...
            <TabsContent value="html" className="mt-2">
              <pre className="whitespace-pre-wrap break-words text-[11px] leading-relaxed bg-muted/40 p-2 rounded font-mono text-foreground max-h-96 overflow-auto">
                {result.body || "(vuoto)"}
              </pre>
            </TabsContent>
          </Tabs>
        ...
        {preContext && (
          <details className="group">
            <summary className="cursor-pointer text-xs uppercase tracking-wide text-foreground mb-1 hover:text-foreground transition-colors">
