import { Mail, MessageCircle, Linkedin, Phone, Megaphone, ArrowUpRight, Bot, Pencil, RefreshCw } from "lucide-react";
...
export const PARTNER_TYPE_META: Record<string, { label: string; tone: string }> = {
  wca_partner: {
    label: "Partner WCA",
    tone: "bg-indigo-500/15 text-indigo-600 dark:text-indigo-400 border-indigo-500/30",
  },
  customer: {
    label: "Cliente",
