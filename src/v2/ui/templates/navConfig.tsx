...
import {
  LayoutDashboard, Command, Search, Mail, Brain, Settings, Inbox, Users,
} from "lucide-react";
...
/**
 * Destinazioni canoniche del menu — flat list.
 *
 * UX redesign apr 2026:
 *   Le 3 voci separate (WCA Partner, Contatti CRM, Biglietti, Pipeline CRM)
 *   sono state unificate in **1 sola voce "Contatti"** che apre la pipeline
 *   unica con selettore di origine (?origine=wca|crm|biglietti).
 */
export const navItemsDef: readonly NavItemDef[] = [
  ...
  { labelKey: "nav.contatti",     path: "/v2/pipeline",     icon: <Users className="h-4 w-4" />,           pinned: true, pinOrder: 3 },
