...
export const ATECO_RANKING_2: Record<string, AtecoRank> = {
  "28.1": {
    ...
    note: "Macchinari agricoltura — export forte",
  },
  "28.2": {
    volume: 4,
    valore: 2,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Macchinari costruzioni — pesanti ma export",
  },
  "28.3": {
    volume: 5,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Macchinari alimentare — fortissimo export",
  },
  "28.4": {
    volume: 5,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Macchinari tessile — distretto export",
  },
  "28.5": {
    volume: 4,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Macchinari carta/stampa — export",
  },
  "28.6": {
    volume: 5,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Macchinari metallo — export forte",
  },
  "28.7": {
    volume: 5,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Macchinari industrie specifiche — export",
  },
  "28.9": {
    volume: 4,
    valore: 3,
  ...
  "29": {
    ...
    note: "Autoveicoli — componentistica export",
  },
  "29.1": {
    volume: 3,
    valore: 2,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Fabbricazione auto — OEM, logistica propria",
  },
  "29.2": {
    volume: 4,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Parti accessori — componentistica express, PAGANO",
  },
  "29.3": {
    volume: 1,
    valore: 1,
    ...
    paga: "IMPROBABILE",
    note: "Riparazione auto — locale, non esporta",
  },
  ...
  "30": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Mezzi trasporto — nautica, aerospaziale",
  },
  "30.1": {
    volume: 3,
    valore: 2,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Navi — componentistica, non la nave intera",
  },
  ...
  "30.3": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Aeromobili — altissimo valore, ricambi express",
  },
  ...
  "31": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Mobili — design italiano, export forte",
  },
  "31.1": {
    volume: 4,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Mobili ufficio — contract export",
  },
  "31.2": {
    volume: 4,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Arredamento — design italiano",
  },
  ...
  "32": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Gioielleria, occhiali, medicali — altissimo valore",
  },
  "32.1": {
    volume: 4,
    valore: 5,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Gioielleria — altissimo valore/kg, corriere express",
  },
  "32.2": {
    volume: 2,
    valore: 3,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Strumenti musicali — nicchia, alto valore unitario",
  },
  "32.3": {
    volume: 3,
    valore: 3,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Articoli sportivi — export, medio valore",
  },
  "32.4": {
    volume: 3,
    valore: 2,
    intl: "MEDIO",
    paga: "POSSIBILE",
    note: "Giocattoli — qualche export, basso valore/kg",
  },
  "32.5": {
    volume: 4,
    valore: 5,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Articoli medici — altissimo valore, express",
  },
  "32.9": {
    volume: 3,
    valore: 3,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Occhiali, varie — export italiano",
  },
  ...
  "33.2": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Installazione macchine — trasfertisti con ricambi",
  },
  ...
  "35.4": {
    ...
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Vapore aria condizionata — servizio",
  },
  ...
  "45.3": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Ricambi auto — export significativo",
  },
  ...
  "46": {
    ...
    intl: "ALTO",
    paga: "POSSIBILE",
    note: "Grossisti — intermediari, NON tutti pagano spedizioni",
  },
  "46.1": {
    volume: 2,
    valore: 2,
    intl: "MEDIO",
    paga: "POSSIBILE",
    note: "Intermediari — agenti, poco volume diretto",
  },
  "46.2": {
    volume: 2,
    valore: 1,
    intl: "BASSO",
    paga: "IMPROBABILE",
    note: "Materie prime agricole — bulk, grossisti non pagano",
  },
  "46.3": {
    volume: 3,
    valore: 2,
    intl: "ALTO",
    paga: "POSSIBILE",
    note: "Alimentari ingrosso — export food, ma spesso FOB",
  },
  "46.4": {
    volume: 4,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Beni consumo — moda, cosmetica, MIGLIORE del 46",
  },
  "46.5": {
    volume: 4,
    valore: 4,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "IT/telecom ingrosso — alto valore, express",
  },
  ...
  "47.3": {
    ...
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Carburante — stazioni servizio",
  },
  ...
  "49": {
    ...
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Concorrente — trasporto terrestre",
  },
  ...
  "49.2": {
    ...
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Ferroviario merci — concorrente",
  },
  ...
  "49.4": {
    ...
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Stradale merci — concorrente diretto",
  },
  ...
  "52": {
    ...
    intl: "BASSO",
    paga: "POSSIBILE",
    note: "Magazzinaggio — potenziale partner, non concorrente puro",
  },
  ...
  "52.2": {
    ...
    intl: "MEDIO",
    paga: "POSSIBILE",
    note: "Supporto trasporti — spedizionieri, agenti",
  },
  "53": {
    volume: 1,
    valore: 1,
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Concorrente diretto — corrieri e poste",
  },
  "53.1": {
    volume: 1,
    valore: 1,
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Poste e corrieri — concorrente",
  },
};
