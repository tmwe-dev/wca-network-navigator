...
export const ATECO_RANKING_1: Record<string, AtecoRank> = {
  ...
  "01": {
    ...
    intl: "MEDIO",
    paga: "POSSIBILE",
    note: "Prodotti deperibili, spesso gestiti da grossisti",
  },
  "01.1": {
    volume: 2,
    valore: 1,
    intl: "BASSO",
    paga: "IMPROBABILE",
    note: "Cereali e ortaggi — bulk, basso valore/kg",
  },
  "01.2": {
    volume: 3,
    valore: 2,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Frutta, vino, olio — export italiano forte",
  },
  ...
  "02.2": {
    ...
    intl: "BASSO",
    paga: "IMPROBABILE",
    note: "Prodotti forestali non legnosi — nicchia",
  },
  ...
  "06": {
    volume: 1,
    valore: 1,
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Petrolio — pipeline, non corriere",
  },
  ...
  "09": {
    ...
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Servizi supporto — non spediscono merci",
  },
  ...
  "10": {
    ...
    valore: 2,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Food italiano = export mondiale, produttori DOP/IGP pagano spedizioni",
  },
  "10.1": {
    volume: 3,
    valore: 2,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Carni — catena freddo, export salumi DOP",
  },
  ...
  "10.3": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Frutta ortaggi — conserve, export",
  },
  "10.4": {
    volume: 4,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Olio d'oliva — export fortissimo, alto valore",
  },
  "10.5": {
    volume: 4,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Formaggi DOP — export forte, alto valore",
  },
  ...
  "10.7": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Pasta e prodotti da forno — simbolo export",
  },
  "10.8": {
    volume: 4,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Dolciumi, caffè, cioccolato — alto valore",
  },
  ...
  "11": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Vino, spirits — alto valore, export fortissimo",
  },
  "11.1": {
    volume: 4,
    valore: 4,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Spirits — altissimo valore, export",
  },
  "11.2": {
    volume: 3,
    valore: 2,
    intl: "MEDIO",
    paga: "POSSIBILE",
    note: "Bevande analcoliche — prevalentemente domestico",
  },
  ...
  "13": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Tessile italiano — export forte, alto valore",
  },
  "13.1": {
    volume: 3,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Filatura — materia prima tessile",
  },
  "13.2": {
    volume: 4,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Tessitura — tessuti pregiati export",
  },
  "13.3": {
    volume: 3,
    valore: 3,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Finissaggio — conto terzi, meno export diretto",
  },
  "13.9": {
    volume: 3,
    valore: 3,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Altre tessili — tappeti, cordami",
  },
  ...
  "14": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Abbigliamento — corriere espresso intensivo, alto valore/kg",
  },
  "14.1": {
    volume: 5,
    valore: 5,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Abbigliamento in pelle — lusso, altissimo valore",
  },
  "14.2": {
    volume: 4,
    valore: 4,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Abbigliamento su misura — sartoria export",
  },
  "14.3": {
    volume: 5,
    valore: 4,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Accessori moda — alto valore, express",
  },
  ...
  "15": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Pelletteria/calzature — lusso italiano, altissimo valore/kg",
  },
  "15.1": {
    volume: 5,
    valore: 5,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Borse, valigeria — lusso, corriere express",
  },
  "15.2": {
    volume: 5,
    valore: 5,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Calzature — Made in Italy, altissimo valore",
  },
  ...
  "19": {
    ...
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Petrolio raffinato — cisterne, non corriere",
  },
  ...
  "20": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Chimica — export forte, prodotti specializzati",
  },
  ...
  "20.2": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Chimici organici — specializzati",
  },
  ...
  "20.5": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Cosmetica, profumeria — altissimo export Italia",
  },
  ...
  "21": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Farmaceutico — altissimo valore/kg, express obbligatorio",
  },
  "21.1": {
    volume: 5,
    valore: 5,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Farmaceutico — express, cold chain, PAGANO",
  },
  ...
  "22": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Gomma/plastica — componentistica export",
  },
  ...
  "22.2": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Plastica — packaging, componentistica",
  },
  ...
  "23.4": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Ceramica artistica — export design italiano",
  },
  ...
  "23.6": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Marmo pietra — export design italiano",
  },
  ...
  "24": {
    ...
    intl: "MEDIO",
    paga: "POSSIBILE",
    note: "Metallurgia — bulk, qualche specializzazione",
  },
  ...
  "24.4": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Metalli non ferrosi — alluminio, rame, più valore",
  },
  ...
  "25": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Prodotti metallo — componentistica export",
  },
  ...
  "25.3": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Generatori vapore — specializzati",
  },
  "25.4": {
    volume: 2,
    valore: 3,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Armi munizioni — regolamentato, alto valore",
  },
  ...
  "25.7": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Articoli in metallo — componentistica",
  },
  "25.9": {
    volume: 3,
    valore: 2,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Vari metallo — componentistica",
  },
  ...
  "26": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Elettronica/ottica — altissimo valore/kg, corriere express",
  },
  "26.1": {
    volume: 5,
    valore: 5,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Componenti elettronici — altissimo valore",
  },
  "26.2": {
    volume: 5,
    valore: 5,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Computer — express obbligatorio",
  },
  ...
  "26.5": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Strumenti precisione, orologi — altissimo valore",
  },
  "26.6": {
    volume: 4,
    valore: 5,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Ottica — altissimo valore/kg",
  },
  "26.7": {
    volume: 5,
    valore: 5,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Medicale — express, altissimo valore",
  },
  "26.8": {
    volume: 3,
    valore: 3,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Supporti magnetici — nicchia in calo",
  },
  ...
  "27": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Apparecchiature elettriche — alto valore, export forte",
  },
  "27.1": {
    volume: 4,
    valore: 3,
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Motori trasformatori — export",
  },
  ...
  "27.4": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Illuminazione — design italiano, export forte",
  },
  ...
  "27.9": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Articoli elettrici vari — export",
  },
  ...
  "28": {
    ...
    intl: "MOLTO ALTO",
    paga: "SI - ALTA PROBABILITÀ",
    note: "Macchinari — cuore export italiano, ricambi express",
  },
};
