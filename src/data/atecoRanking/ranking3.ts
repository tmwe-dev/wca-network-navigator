...
export const ATECO_RANKING_3: Record<string, AtecoRank> = {
  ...
  "62": {
    ...
    paga: "IMPROBABILE",
    note: "Software/IT — zero merci fisiche",
  },
  ...
  "70.1": {
    ...
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Direzione aziendale — servizio",
  },
  ...
  "72": {
    ...
    note: "Ricerca — campioni, strumenti scientifici, express",
  },
  "72.1": {
    volume: 3,
    valore: 4,
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "R&D scienze naturali — campioni, reagenti express",
  },
  ...
  "74.1": {
    ...
    intl: "ALTO",
    paga: "SI - MEDIA PROBABILITÀ",
    note: "Design industriale — prototipi, campioni",
  },
  ...
  "74.3": {
    ...
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Traduzione — servizio digitale",
  },
  ...
  "87": {
    ...
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Assistenza residenziale — locale",
  },
  ...
  "90.3": {
    ...
    intl: "MEDIO",
    paga: "POSSIBILE",
    note: "Musei — prestiti opere d'arte internazionali",
  },
  "90.4": {
    volume: 1,
    valore: 1,
    intl: "MOLTO DIFFICILE",
    paga: "IMPROBABILE",
    note: "Giardinaggio — locale, zero export",
  },
