...
Generato 2026-08-06. Basato su match esatto di basename.
**29 candidati** — verificare uno per uno prima di eliminare.
...
| `activities.ts` | `src/application/data/activities.ts` | `src/v2/io/supabase/queries/activities.ts` |
| `activities.ts` | `src/data/activities.ts` | `src/v2/io/supabase/queries/activities.ts` |
| `agents.ts` | `src/application/data/agents.ts` | `src/v2/io/supabase/queries/agents.ts` |
| `agents.ts` | `src/data/agents.ts` | `src/v2/io/supabase/queries/agents.ts` |
| `blacklist.ts` | `src/application/data/blacklist.ts` | `src/v2/ui/pages/command/tools/blacklist.ts` |
...
| `cockpit.ts` | `src/types/cockpit.ts` | `src/v2/io/supabase/queries/cockpit.ts` |
| `contacts.ts` | `src/application/data/contacts.ts` | `src/v2/io/supabase/queries/contacts.ts` |
...
| `deepSearch.ts` | `src/data/deepSearch.ts` | `src/v2/services/bulkOps/entries/deepSearch.ts` |
| `diagnostics.ts` | `src/data/diagnostics.ts` | `src/v2/ui/pages/prompt-lab/hooks/diagnostics.ts` |
...
| `operators.ts` | `src/application/data/operators.ts` | `src/v2/io/supabase/queries/operators.ts` |
| `operators.ts` | `src/data/operators.ts` | `src/v2/io/supabase/queries/operators.ts` |
| `partners.ts` | `src/application/data/partners.ts` | `src/v2/io/supabase/queries/partners.ts` |
| `partners.ts` | `src/data/partners.ts` | `src/v2/io/supabase/queries/partners.ts` |
| `prospects.ts` | `src/application/data/prospects.ts` | `src/v2/io/supabase/queries/prospects.ts` |
