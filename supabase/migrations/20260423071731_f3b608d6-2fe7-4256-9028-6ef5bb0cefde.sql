...
DROP TRIGGER IF EXISTS trigger_quality_on_enrichment_update ON public.partners;
...
DROP TRIGGER IF EXISTS trigger_quality_on_profile_update ON public.partners;
...
DROP TRIGGER IF EXISTS trigger_quality_on_membership_update ON public.partners;
...
DROP TRIGGER IF EXISTS trigger_quality_on_contact_change ON public.partner_contacts;
...
DROP TRIGGER IF EXISTS trigger_quality_on_network_change ON public.partner_networks;
...
DROP TRIGGER IF EXISTS trigger_quality_on_certification_change ON public.partner_certifications;
...
DROP TRIGGER IF EXISTS trigger_quality_on_service_change ON public.partner_services;
...
DROP TRIGGER IF EXISTS trigger_quality_on_sherlock_complete ON public.sherlock_investigations;
