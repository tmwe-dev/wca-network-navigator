...
BEGIN
  ...
  -- Filtri newsletter/spam/no-reply (restano attivi)
  ...
  -- 1 email = 1 mittente: nessuna attribuzione per dominio. Si usa direttamente
  -- il partner_id risolto sopra (esatto o NULL).
