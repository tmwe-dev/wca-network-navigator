...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'partners_shared_read'
  ) THEN
    CREATE POLICY "partners_shared_read"
    ON public.partners
    FOR SELECT
    TO authenticated
...
BEGIN
  IF NOT EXISTS (
    ...
    FROM pg_policies
    WHERE schemaname = 'public'
      AND tablename = 'partner_contacts'
      AND policyname = 'partner_contacts_shared_read'
  ) THEN
    CREATE POLICY "partner_contacts_shared_read"
