...
DROP TRIGGER IF EXISTS trg_on_inbound_message ON public.channel_messages;
CREATE TRIGGER trg_on_inbound_message
  AFTER INSERT ON public.channel_messages
  FOR EACH ROW
  WHEN (NEW.direction = 'inbound')
  EXECUTE FUNCTION public.on_inbound_message();