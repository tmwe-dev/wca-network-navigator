...
export const DATA_ACCESS_TOOLS: ToolDefinition[] = [
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          has_profile: {
            type: "boolean",
            description: "Has profile description (sourced from WCA sync — populated for ≥99% of records)",
          },
          ...
          certification: {
            type: "string",
            enum: ["IATA", "BASC", "ISO", "C-TPAT", "AEO"],
            description: "Filter by certification",
          },
          network_name: { type: "string", description: "Filter by network membership name" },
          sort_by: {
            type: "string",
            enum: ["rating", "name", "recent", "seniority"],
            description: "Sort order. 'seniority' = longest WCA membership first (by member_since)",
          },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          sort_by: {
            type: "string",
            enum: ["total", "missing_profiles", "missing_emails"],
            description: "How to rank countries",
          },
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "High-level summary of the entire database: total partners, countries, profiles, emails, phones, directory coverage, active jobs.",
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Search imported contacts (CRM). Filter by name, company, country, email, origin, lead_status, group (import_log_id).",
      parameters: {
        type: "object",
        properties: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Search Italian prospects (Report Aziende). Filter by company name, city, province, codice_ateco, fatturato range, lead_status.",
      parameters: {
        type: "object",
        properties: {
          company_name: { type: "string", description: "Company name (partial match)" },
