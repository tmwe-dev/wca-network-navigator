...
export const WRITING_TOOLS: ToolDefinition[] = [
  {
    ...
    function: {
      name: "update_partner",
      description:
        "Update specific fields of a partner. Supports: is_favorite, lead_status, rating, company_alias. Resolves company_name to partner_id automatically.",
      parameters: {
        type: "object",
        properties: {
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          interaction_type: {
            type: "string",
            enum: ["note", "email", "phone_call", "meeting", "other"],
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Update lead status of imported contacts. Can target specific IDs or filter by company_name/country.",
      parameters: {
        type: "object",
        properties: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Update multiple partners at once. Filter by country_code or provide partner_ids. Supports updating is_favorite and lead_status.",
      parameters: {
        type: "object",
        properties: {
  ...
  },
  {
    ...
    function: {
      name: "delete_records",
      description:
        "Delete records from the system. Supports partners, contacts, prospects, activities. ALWAYS ask for confirmation before deleting.",
      parameters: {
        type: "object",
        properties: {
          table: {
            type: "string",
            enum: ["partners", "imported_contacts", "prospects", "activities", "reminders"],
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          source_type: {
            type: "string",
            enum: ["partner", "prospect", "contact"],
            description: "Entity type (default: partner)",
          },
          partner_id: { type: "string", description: "UUID of the partner" },
          company_name: { type: "string", description: "Company name to resolve partner_id" },
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Generate an outreach message (email, LinkedIn, WhatsApp, SMS) for a contact using AI. Returns subject + body ready to send or review.",
      parameters: {
        type: "object",
        properties: {
          channel: {
            type: "string",
            enum: ["email", "linkedin", "whatsapp", "sms"],
  ...
  },
  {
    ...
    function: {
      name: "send_email",
      description:
        "Send an email to a partner contact. Requires recipient email, subject, and HTML body. The email is sent via the configured SMTP server.",
      parameters: {
        type: "object",
        properties: {
  ...
  },
  {
    ...
    function: {
      name: "create_contact",
      description:
        "Create a new contact in the CRM (imported_contacts). Automatically triggers WCA partner matching if email or company_name is provided.",
      parameters: {
        type: "object",
        properties: {
          name: { type: "string", description: "Contact full name" },
