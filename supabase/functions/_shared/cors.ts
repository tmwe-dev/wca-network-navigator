...
export function getCorsHeaders(requestOrigin?: string | null): Record<string, string> {
  ...
  return {
    ...
    "Access-Control-Allow-Headers":
      "authorization, x-client-info, apikey, content-type, x-supabase-client-platform, x-supabase-client-platform-version, x-supabase-client-runtime, x-supabase-client-runtime-version, x-mailbox-id, x-sync-user-id, x-cron-secret, x-injection-review-id, x-unread-only",
