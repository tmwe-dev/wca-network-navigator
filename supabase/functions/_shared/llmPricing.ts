...
const PRICING: Record<string, ModelPricing> = {
  ...
  "google/gemini-2.5-flash": { promptUsdPer1M: 0.3, completionUsdPer1M: 2.5 },
  "google/gemini-2.5-flash-lite": { promptUsdPer1M: 0.075, completionUsdPer1M: 0.3 },
  "google/gemini-3-flash-preview": { promptUsdPer1M: 0.3, completionUsdPer1M: 2.5 },
  "google/gemini-3.1-flash-preview": { promptUsdPer1M: 0.3, completionUsdPer1M: 2.5 },
  ...
  "google/gemini-3.1-flash-image-preview": { promptUsdPer1M: 0.3, completionUsdPer1M: 2.5 },

  // OpenAI
  "openai/gpt-5": { promptUsdPer1M: 2.5, completionUsdPer1M: 10.0 },
  "openai/gpt-5-mini": { promptUsdPer1M: 0.25, completionUsdPer1M: 2.0 },
  "openai/gpt-5-nano": { promptUsdPer1M: 0.05, completionUsdPer1M: 0.4 },
  "openai/gpt-5.2": { promptUsdPer1M: 2.5, completionUsdPer1M: 10.0 },
  "openai/gpt-4o-mini": { promptUsdPer1M: 0.15, completionUsdPer1M: 0.6 },
  "openai/gpt-4o": { promptUsdPer1M: 2.5, completionUsdPer1M: 10.0 },

  // Anthropic
  "anthropic/claude-3-5-sonnet": { promptUsdPer1M: 3.0, completionUsdPer1M: 15.0 },
  "anthropic/claude-3-5-haiku": { promptUsdPer1M: 0.8, completionUsdPer1M: 4.0 },
};

/** Default fallback se modello sconosciuto (Gemini Flash pricing). */
const DEFAULT_PRICING: ModelPricing = { promptUsdPer1M: 0.3, completionUsdPer1M: 2.5 };
