...
export async function handleCheckBlacklist(args: Record<string, unknown>): Promise<unknown> {
...
export async function handleGetOperationsDashboard(userId: string): Promise<unknown> {
