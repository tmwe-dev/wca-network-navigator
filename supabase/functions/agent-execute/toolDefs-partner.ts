...
export const PARTNER_TOOLS: Record<string, unknown> = {
  search_partners: {
    ...
    function: {
      ...
      description:
        "Search and filter partners. Supports country, city, name, rating, email/phone/profile presence, office type, favorites, services.",
      parameters: {
        type: "object",
        properties: {
  ...
  get_country_overview: {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: { country_code: { type: "string" }, sort_by: { type: "string" }, limit: { type: "number" } },
      },
    },
  },
  get_directory_status: {
    ...
    function: {
      ...
      description:
        "Local data coverage status for countries. Uses already synchronized internal partner/profile/contact data only; it never scans or downloads WCA directories.",
  ...
  list_jobs: {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: { status: { type: "string" }, country_code: { type: "string" }, limit: { type: "number" } },
      },
    },
  },
  get_global_summary: {
