...
const log = createLogger("get-ra-credentials");
...
Deno.serve(async (req) => {
  trackUsage("get-ra-credentials", "quarantine", { note: "Q2 bonifica, scadenza 2026-10-02" });
  ...
  try {
    ...
    log.error("get-ra-credentials error:", e);
