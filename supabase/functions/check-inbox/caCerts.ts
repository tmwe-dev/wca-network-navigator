/**
 * caCerts.ts — CA certificate bundles for IMAP TLS connections.
 * Extracted from check-inbox/index.ts (lines 9-166).
 */
...
export function getCaCertsForHost(host: string): string[] {
