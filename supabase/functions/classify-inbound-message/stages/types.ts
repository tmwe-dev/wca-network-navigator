...
export type EmailCategory = "interested" | "not_interested" | "request_info" | "question" | "meeting_request" | "complaint" | "follow_up" | "auto_reply" | "unsubscribe" | "bounce" | "spam" | "uncategorized";
...
export function mapInboundToEmailCategory(
  ...
  const mapping: Record<ClassificationValue, EmailCategory> = {
    positive: "interested",
  ...
  return mapping[inboundClassification] || "uncategorized";
}
...
export function makeRecordStage(supabase: import("../../_shared/supabaseClient.ts").AnySupabaseClient, messageId: string, userId: string | null) {
